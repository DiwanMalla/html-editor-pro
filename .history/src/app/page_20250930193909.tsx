...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main
        className={`${
          isEditorFullscreen ? "h-screen" : "h-[calc(100vh-4rem)]"
        }`}
      >
        {/* Welcome Section */}
        {!isEditorFullscreen && (
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              ...
              JavaScript with real-time preview, syntax highlighting, and modern
              development tools all in one place.
            </p>
          </motion.div>
        )}
        ...
        {/* Editor */}
        <div
          className={`${isEditorFullscreen ? "h-full" : "h-full px-4 pb-4"}`}
        >
          <motion.div
