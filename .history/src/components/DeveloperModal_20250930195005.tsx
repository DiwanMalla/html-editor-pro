            ...
            <div className="p-10">
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                <div className="text-center p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                  <div className="text-violet-500 font-bold text-2xl">5+</div>
                  <div className="text-slate-500 dark:text-slate-400 text-sm font-medium">Years Coding</div>
                </div>
                <div className="text-center p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                  <div className="text-purple-500 font-bold text-2xl">50+</div>
                  <div className="text-slate-500 dark:text-slate-400 text-sm font-medium">Projects Built</div>
                </div>
                <div className="text-center p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                  <div className="text-pink-500 font-bold text-2xl">∞</div>
                  <div className="text-slate-500 dark:text-slate-400 text-sm font-medium">Coffee Cups</div>
                </div>
              </div>
